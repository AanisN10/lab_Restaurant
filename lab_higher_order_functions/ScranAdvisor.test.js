...
describe('ScranAdvisor', () => {
    ...
    test('can count the number of restaurants', () => {
        const expected = 23;
        const actual = scranAdvisor.canCountRestaurants(restaurants.length);
    ...
    test('can find Happy Lamb Hot Pot restaurant by full name', () => {
        ...
        const actual = scranAdvisor.findRestaurantByFullName("Happy Lamb Hot Pot");
        expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.findGlasgow("Glasgow");
          expect(actual).toEqual(expected);
    })
